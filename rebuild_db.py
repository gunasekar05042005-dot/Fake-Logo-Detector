# rebuild_db.py
# Rebuilds logo_embeddings_clip.pkl using SmartExtractor (256-dim)
# Same extractor as the new app.py — so they match perfectly
...
def build():
    ...
    print(f"Building SmartExtractor database for {len(brands)} brand(s)...")
